 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const c="https://generativelanguage.googleapis.com",d="v1beta",l="0.21.0",u="genai-js";var h;(function(e){e["GENERATE_CONTENT"]="generateContent",e["STREAM_GENERATE_CONTENT"]="streamGenerateContent",e["COUNT_TOKENS"]="countTokens",e["EMBED_CONTENT"]="embedContent",e["BATCH_EMBED_CONTENTS"]="batchEmbedContents"})(h||(h={}));class f{constructor(e,t,n,o,s){this.model=e,this.task=t,this.apiKey=n,this.stream=o,this.requestOptions=s}toString(){var e,t;const n=(null===(e=this.requestOptions)||void 0===e?void 0:e.apiVersion)||d,o=(null===(t=this.requestOptions)||void 0===t?void 0:t.baseUrl)||c;let s=`${o}/${n}/${this.model}:${this.task}`;return this.stream&&(s+="?alt=sse"),s}}function p(e){const t=[];return(null===e||void 0===e?void 0:e.apiClient)&&t.push(e.apiClient),t.push(`${u}/${l}`),t.join(" ")}async function v(e){var t;const n=new Headers;n.append("Content-Type","application/json"),n.append("x-goog-api-client",p(e.requestOptions)),n.append("x-goog-api-key",e.apiKey);let o=null===(t=e.requestOptions)||void 0===t?void 0:t.customHeaders;if(o){if(!(o instanceof Headers))try{o=new Headers(o)}catch(s){throw new r(`unable to convert customHeaders value ${JSON.stringify(o)} to Headers: ${s.message}`)}for(const[e,t]of o.entries()){if("x-goog-api-key"===e)throw new r(`Cannot set reserved header name ${e}`);if("x-goog-api-client"===e)throw new r(`Header name ${e} can only be set using the apiClient field`);n.append(e,t)}}return n}async function g(e,t,n,o,s,i){const a=new f(e,t,n,o,i);return{url:a.toString(),fetchOptions:Object.assign(Object.assign({},y(i)),{method:"POST",headers:await v(a),body:s})}}async function m(e,t,n,o,s,i={},a=fetch){const{url:r,fetchOptions:c}=await g(e,t,n,o,s,i);return E(r,c,a)}async function E(e,t,n=fetch){let o;try{o=await n(e,t)}catch(s){b(s,e)}return o.ok||await C(o,e),o}function b(e,t){let n=e;throw e instanceof a||e instanceof r||(n=new s(`Error fetching from ${t.toString()}: ${e.message}`),n.stack=e.stack),n}async function C(e,t){let n,o="";try{const t=await e.json();o=t.error.message,t.error.details&&(o+=` ${JSON.stringify(t.error.details)}`,n=t.error.details)}catch(s){}throw new a(`Error fetching from ${t.toString()}: [${e.status} ${e.statusText}] ${o}`,e.status,e.statusText,n)}function y(e){const t={};if(void 0!==(null===e||void 0===e?void 0:e.signal)||(null===e||void 0===e?void 0:e.timeout)>=0){const n=new AbortController;(null===e||void 0===e?void 0:e.timeout)>=0&&setTimeout((()=>n.abort()),e.timeout),(null===e||void 0===e?void 0:e.signal)&&e.signal.addEventListener("abort",(()=>{n.abort()})),t.signal=n.signal}return t}
/**
 * @license
 * Copyright 2024 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function O(e){return e.text=()=>{if(e.candidates&&e.candidates.length>0){if(e.candidates.length>1&&console.warn(`This response had ${e.candidates.length} candidates. Returning text from the first candidate only. Access response.candidates directly to use the other candidates.`),R(e.candidates[0]))throw new i(`${w(e)}`,e);return _(e)}if(e.promptFeedback)throw new i(`Text not available. ${w(e)}`,e);return""},e.functionCall=()=>{if(e.candidates&&e.candidates.length>0){if(e.candidates.length>1&&console.warn(`This response had ${e.candidates.length} candidates. Returning function calls from the first candidate only. Access response.candidates directly to use the other candidates.`),R(e.candidates[0]))throw new i(`${w(e)}`,e);return console.warn("response.functionCall() is deprecated. Use response.functionCalls() instead."),T(e)[0]}if(e.promptFeedback)throw new i(`Function call not available. ${w(e)}`,e)},e.functionCalls=()=>{if(e.candidates&&e.candidates.length>0){if(e.candidates.length>1&&console.warn(`This response had ${e.candidates.length} candidates. Returning function calls from the first candidate only. Access response.candidates directly to use the other candidates.`),R(e.candidates[0]))throw new i(`${w(e)}`,e);return T(e)}if(e.promptFeedback)throw new i(`Function call not available. ${w(e)}`,e)},e}function _(e){var t,n,o,s;const i=[];if(null===(n=null===(t=e.candidates)||void 0===t?void 0:t[0].content)||void 0===n?void 0:n.parts)for(const a of null===(s=null===(o=e.candidates)||void 0===o?void 0:o[0].content)||void 0===s?void 0:s.parts)a.text&&i.push(a.text),a.executableCode&&i.push("\n```"+a.executableCode.language+"\n"+a.executableCode.code+"\n```\n"),a.codeExecutionResult&&i.push("\n```\n"+a.codeExecutionResult.output+"\n```\n");return i.length>0?i.join(""):""}function T(e){var t,n,o,s;const i=[];if(null===(n=null===(t=e.candidates)||void 0===t?void 0:t[0].content)||void 0===n?void 0:n.parts)for(const a of null===(s=null===(o=e.candidates)||void 0===o?void 0:o[0].content)||void 0===s?void 0:s.parts)a.functionCall&&i.push(a.functionCall);return i.length>0?i:void 0}const I=[t.FinishReason.RECITATION,t.FinishReason.SAFETY,t.FinishReason.LANGUAGE];function R(e){return!!e.finishReason&&I.includes(e.finishReason)}function w(e){var t,n,o;let s="";if(e.candidates&&0!==e.candidates.length||!e.promptFeedback){if(null===(o=e.candidates)||void 0===o?void 0:o[0]){const t=e.candidates[0];R(t)&&(s+=`Candidate was blocked due to ${t.finishReason}`,t.finishMessage&&(s+=`: ${t.finishMessage}`))}}else s+="Response was blocked",(null===(t=e.promptFeedback)||void 0===t?void 0:t.blockReason)&&(s+=` due to ${e.promptFeedback.blockReason}`),(null===(n=e.promptFeedback)||void 0===n?void 0:n.blockReasonMessage)&&(s+=`: ${e.promptFeedback.blockReasonMessage}`);return s}function S(e){return this instanceof S?(this.v=e,this):new S(e)}function A(e,t,n){if(!Symbol.asyncIterator)throw new TypeError("Symbol.asyncIterator is not defined.");var o,s=n.apply(e,t||[]),i=[];return o={},a("next"),a("throw"),a("return"),o[Symbol.asyncIterator]=function(){return this},o;function a(e){s[e]&&(o[e]=function(t){return new Promise((function(n,o){i.push([e,t,n,o])>1||r(e,t)}))})}function r(e,t){try{c(s[e](t))}catch(n){u(i[0][3],n)}}function c(e){e.value instanceof S?Promise.resolve(e.value.v).then(d,l):u(i[0][2],e)}function d(e){r("next",e)}function l(e){r("throw",e)}function u(e,t){e(t),i.shift(),i.length&&r(i[0][0],i[0][1])}}"function"===typeof SuppressedError&&SuppressedError;
/**
 * @license
 * Copyright 2024 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function G(e,t,n,o){const s=await m(t,h.STREAM_GENERATE_CONTENT,e,!0,JSON.stringify(n),o);return k(s)}async function H(e,t,n,o){const s=await m(t,h.GENERATE_CONTENT,e,!1,JSON.stringify(n),o),i=await s.json(),a=O(i);return{response:a}}
/**
 * @license
 * Copyright 2024 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const V="SILENT_ERROR";class J{constructor(e,t,n,o={}){this.model=t,this.params=n,this._requestOptions=o,this._history=[],this._sendPromise=Promise.resolve(),this._apiKey=e,(null===n||void 0===n?void 0:n.history)&&(q(n.history),this._history=n.history)}async getHistory(){return await this._sendPromise,this._history}async sendMessage(e,t={}){var n,o,s,i,a,r;await this._sendPromise;const c=F(e),d={safetySettings:null===(n=this.params)||void 0===n?void 0:n.safetySettings,generationConfig:null===(o=this.params)||void 0===o?void 0:o.generationConfig,tools:null===(s=this.params)||void 0===s?void 0:s.tools,toolConfig:null===(i=this.params)||void 0===i?void 0:i.toolConfig,systemInstruction:null===(a=this.params)||void 0===a?void 0:a.systemInstruction,cachedContent:null===(r=this.params)||void 0===r?void 0:r.cachedContent,contents:[...this._history,c]},l=Object.assign(Object.assign({},this._requestOptions),t);let u;return this._sendPromise=this._sendPromise.then((()=>H(this._apiKey,this.model,d,l))).then((e=>{var t;if(e.response.candidates&&e.response.candidates.length>0){this._history.push(c);const n=Object.assign({parts:[],role:"model"},null===(t=e.response.candidates)||void 0===t?void 0:t[0].content);this._history.push(n)}else{const t=w(e.response);t&&console.warn(`sendMessage() was unsuccessful. ${t}. Inspect response object for details.`)}u=e})),await this._sendPromise,u}async sendMessageStream(e,t={}){var n,o,s,i,a,r;await this._sendPromise;const c=F(e),d={safetySettings:null===(n=this.params)||void 0===n?void 0:n.safetySettings,generationConfig:null===(o=this.params)||void 0===o?void 0:o.generationConfig,tools:null===(s=this.params)||void 0===s?void 0:s.tools,toolConfig:null===(i=this.params)||void 0===i?void 0:i.toolConfig,systemInstruction:null===(a=this.params)||void 0===a?void 0:a.systemInstruction,cachedContent:null===(r=this.params)||void 0===r?void 0:r.cachedContent,contents:[...this._history,c]},l=Object.assign(Object.assign({},this._requestOptions),t),u=G(this._apiKey,this.model,d,l);return this._sendPromise=this._sendPromise.then((()=>u)).catch((e=>{throw new Error(V)})).then((e=>e.response)).then((e=>{if(e.candidates&&e.candidates.length>0){this._history.push(c);const t=Object.assign({},e.candidates[0].content);t.role||(t.role="model"),this._history.push(t)}else{const t=w(e);t&&console.warn(`sendMessageStream() was unsuccessful. ${t}. Inspect response object for details.`)}})).catch((e=>{e.message!==V&&console.error(e)})),u}}
/**
 * @license
 * Copyright 2024 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function W(e,t,n,o){const s=await m(t,h.EMBED_CONTENT,e,!1,JSON.stringify(n),o);return s.json()}async function Q(e,t,n,o){const s=n.requests.map((e=>Object.assign(Object.assign({},e),{model:t}))),i=await m(t,h.BATCH_EMBED_CONTENTS,e,!1,JSON.stringify({requests:s}),o);return i.json()}
/**
 * @license
 * Copyright 2024 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Z{constructor(e){this.apiKey=e}getGenerativeModel(e,t){if(!e.model)throw new s("Must provide a model name. Example: genai.getGenerativeModel({ model: 'my-model-name' })");return new z(this.apiKey,e,t)}getGenerativeModelFromCachedContent(e,t,n){if(!e.name)throw new r("Cached content must contain a `name` field.");if(!e.model)throw new r("Cached content must contain a `model` field.");const o=["model","systemInstruction"];for(const i of o)if((null===t||void 0===t?void 0:t[i])&&e[i]&&(null===t||void 0===t?void 0:t[i])!==e[i]){if("model"===i){const n=t.model.startsWith("models/")?t.model.replace("models/",""):t.model,o=e.model.startsWith("models/")?e.model.replace("models/",""):e.model;if(n===o)continue}throw new r(`Different value for "${i}" specified in modelParams (${t[i]}) and cachedContent (${e[i]})`)}const s=Object.assign(Object.assign({},t),{model:e.model,tools:e.tools,toolConfig:e.toolConfig,systemInstruction:e.systemInstruction,cachedContent:e});return new z(this.apiKey,s,n)}}t.ChatSession=J,t.GenerativeModel=z,t.GoogleGenerativeAI=Z,t.GoogleGenerativeAIError=s,t.GoogleGenerativeAIFetchError=a,t.GoogleGenerativeAIRequestInputError=r,t.GoogleGenerativeAIResponseError=i,t.POSSIBLE_ROLES=o},4635:function(e,t,n){n.r(t),n.d(t,{default:function(){return _}});var o=n(6768),s=n(5130),i=n(4232);const a={class:"container mt-5 aipage"},r={class:"row mb-3"},c={class:"col-md-6"},d={class:"col-md-6"},l={class:"mb-3"},u={class:"row mb-3"},h={class:"col-md-6"},f={class:"row mb-3"},p={class:"text-center mb-4"},v={class:"bg-light p-3"};function g(e,t,n,g,m,E){return(0,o.uX)(),(0,o.CE)("div",a,[t[12]||(t[12]=(0,o.Lk)("h1",{class:"text-center mb-4"},"AI Opdracht voor een gedicht",-1)),(0,o.Lk)("div",r,[(0,o.Lk)("div",c,[t[6]||(t[6]=(0,o.Lk)("label",{for:"type"},"Type gedicht",-1)),(0,o.bo)((0,o.Lk)("select",{class:"form-select","onUpdate:modelValue":t[0]||(t[0]=t=>e.type=t)},t[5]||(t[5]=[(0,o.Fv)('<option value="sonnet" data-v-4593b2fb>Sonnet</option><option value="limerick" data-v-4593b2fb>Limerick</option><option value="haiku" data-v-4593b2fb>Haiku</option><option value="ode" data-v-4593b2fb>Ode</option><option value="klankdicht" data-v-4593b2fb>Klankdicht</option><option value="rap" data-v-4593b2fb>Rap</option>',6)]),512),[[s.u1,e.type]])]),(0,o.Lk)("div",d,[t[8]||(t[8]=(0,o.Lk)("label",{for:"theme"},"Thema",-1)),(0,o.bo)((0,o.Lk)("select",{class:"form-select","onUpdate:modelValue":t[1]||(t[1]=t=>e.theme=t)},t[7]||(t[7]=[(0,o.Fv)('<option value="liefde" data-v-4593b2fb>Liefde</option><option value="dood" data-v-4593b2fb>Dood</option><option value="de natuur" data-v-4593b2fb>De natuur</option><option value="natuurverschijnselenen" data-v-4593b2fb>Natuurverschijnselenen</option><option value="moeder" data-v-4593b2fb>Moeder</option><option value="vader" data-v-4593b2fb>Vader</option><option value="kind" data-v-4593b2fb>Kind</option><option value="vriendschap" data-v-4593b2fb>Vriendschap</option><option value="ouder worden" data-v-4593b2fb>Ouder worden</option>',9)]),512),[[s.u1,e.theme]])])]),(0,o.Lk)("div",l,[t[9]||(t[9]=(0,o.Lk)("label",{for:"prompt"},"Extra info",-1)),(0,o.bo)((0,o.Lk)("input",{class:"form-control","onUpdate:modelValue":t[2]||(t[2]=e=>m.prompt=e),placeholder:"Je denkt terug aan je jeugd, waarin je gelukkig was en je fijne herinneringen had."},null,512),[[s.Jo,m.prompt]])]),(0,o.Lk)("div",u,[(0,o.Lk)("div",h,[t[11]||(t[11]=(0,o.Lk)("label",{for:"emotion"},"Emotie",-1)),(0,o.bo)((0,o.Lk)("select",{class:"form-select","onUpdate:modelValue":t[3]||(t[3]=t=>e.emotion=t)},t[10]||(t[10]=[(0,o.Fv)('<option value="blij" data-v-4593b2fb>Blij</option><option value="verdrietig" data-v-4593b2fb>Verdrietig</option><option value="boos" data-v-4593b2fb>Boos</option><option value="verliefd" data-v-4593b2fb>Verliefd</option><option value="bang" data-v-4593b2fb>Bang</option><option value="verrast" data-v-4593b2fb>Verrast</option><option value="teleurgesteld" data-v-4593b2fb>Teleurgesteld</option><option value="gefrustreerd" data-v-4593b2fb>Gefrustreerd</option><option value="verward" data-v-4593b2fb>Verward</option><option value="opgelucht" data-v-4593b2fb>Opgelucht</option><option value="trots" data-v-4593b2fb>Trots</option><option value="jaloers" data-v-4593b2fb>Jaloers</option><option value="verlegen" data-v-4593b2fb>Verlegen</option><option value="geirriteerd" data-v-4593b2fb>Geirriteerd</option><option value="gelukkig" data-v-4593b2fb>Gelukkig</option><option value="neutraal" data-v-4593b2fb>Neutraal</option>',16)]),512),[[s.u1,e.emotion]])])]),(0,o.Lk)("div",f,[(0,o.Lk)("div",p,[(0,o.Lk)("button",{class:"btn btn-primary",onClick:t[4]||(t[4]=(...e)=>E.getPoem&&E.getPoem(...e))},"Genereer gedicht")]),((0,o.uX)(!0),(0,o.CE)(o.FK,null,(0,o.pI)(m.chatsession,(e=>((0,o.uX)(),(0,o.CE)("div",{key:e.id,class:"mb-3"},[(0,o.Lk)("pre",v,(0,i.v_)(e.answer),1)])))),128))])])}n(4114);const{GoogleGenerativeAI:m}=n(4322),E=new m("AIzaSyBEpQXdlGYv-JeOkBQFqL25N3rGiWWnFRo"),b=E.getGenerativeModel({model:"gemini-1.5-flash"});var C={data(){return{prompt:"",answer:"",chatsession:[]}},methods:{async getPoem(){this.chatsession=[];var e=`Schrijf een ${this.type} gedicht over ${this.theme}. En laat de emotie ${this.emotion} erin overheersen, of gradueel toenemen of afnemen. Gebruik een enkel moeilijk of ongebruikelijk woord. Steel af en toe uit bekende gedichten van oude oude bekende dichters.`,t="Het gedicht mag maximaal 33 regels zijn.";const n=await b.generateContent(e+this.prompt+"."+t);this.answer=`${n.response.text()}`,this.chatsession.push({id:this.chatsession.length,prompt:this.prompt,answer:this.answer}),this.prompt=""}}},y=n(1241);const O=(0,y.A)(C,[["render",g],["__scopeId","data-v-4593b2fb"]]);var _=O},2772:function(e,t,n){n.r(t),n.d(t,{default:function(){return E}});var o=n(6768),s=n(4232);const i={class:"container mt-5"},a={class:"text-center"},r={class:"text-center mb-4"},c={key:0,class:"text-center"},d={key:1,class:"text-center"};function l(e,t,n,l,u,h){return(0,o.uX)(),(0,o.CE)("div",i,[t[1]||(t[1]=(0,o.Lk)("h1",{class:"text-center mb-4"},"Naam herkenning",-1)),t[2]||(t[2]=(0,o.Lk)("p",{class:"text-center"},"Spreek de naam van de leerling en kijk of de naam wordt herkend.",-1)),(0,o.Lk)("p",a,"Te herkennen namen zijn: "+(0,s.v_)(l.namenLijst),1),(0,o.Lk)("div",r,[(0,o.Lk)("button",{class:"btn btn-primary",onClick:t[0]||(t[0]=(...e)=>l.startLuisteren&&l.startLuisteren(...e))},(0,s.v_)(l.instructie),1)]),l.herkendeNaam?((0,o.uX)(),(0,o.CE)("p",c,"Herkende naam: "+(0,s.v_)(l.herkendeNaam),1)):((0,o.uX)(),(0,o.CE)("p",d,"Geen bekende naam gevonden."))])}n(4114);var u=n(144);const h=";1;367913;;;;;Abdullah Al-Anesi\n;2;360640;;;;;Joris van Beers\n;3;373761;;;;;Rob van den Biggelaar\n;4;330083;;;;;Robin Boersma\n;5;372936;;;;;Alyssia Gülük\n;6;374680;;;;;Milan van Hemert\n;7;374407;;;;;Wilco van den Heuvel\n;8;333886;;;;;Ricardo Kerssens\n;9;377402;;;;;Stan van Pinxten\n;10;342229;;;;;Ian Pipe\n;11;375520;;;;;Jacques Prinsen\n;12;366671;;;;;Noah Schrijver\n;13;376625;;;;;Duc-Tan Ta\n;14;377571;;;;;Stef Tax\n;15;376444;;;;;Marijn van Vugt\n;16;363822;;;;;Angelo Weesenaar\n;17;375871;;;;;Job Zoutewelle",f=h.split("\n").map((e=>e.split(";")[7].split(" ")[0]));var p=f,v={setup(){const e=(0,u.KR)([...p]),t=(0,u.KR)(null),n=(0,u.KR)("Start met luisteren"),o=()=>{navigator.mediaDevices.getUserMedia?navigator.mediaDevices.getUserMedia({audio:!0}).then((e=>{const o=window.SpeechRecognition||window.webkitSpeechRecognition,i=new o;i.lang="nl-NL",i.onresult=e=>{const n=e.results[0][0].transcript,o=s(n);t.value=o},i.start(),i.onstart=()=>{n.value="Ik luister..."},i.onend=()=>{e.getTracks().forEach((e=>e.stop())),n.value="Start opnieuw met luisteren"}})).catch((e=>{console.error("Fout bij het gebruiken van de microfoon:",e)})):console.error("De browser ondersteunt geen getUserMedia")},s=t=>{let n=e.value.find((e=>t.includes(e)));return n||(e.value.push(t),n=t),n};return{startLuisteren:o,herkendeNaam:t,namenLijst:e,instructie:n}}},g=n(1241);const m=(0,g.A)(v,[["render",l]]);var E=m}}]);
//# sourceMappingURL=about.e3a8012e.js.map