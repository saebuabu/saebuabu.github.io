 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function G(e,t,n,o){const s=await g(t,h.STREAM_GENERATE_CONTENT,e,!0,JSON.stringify(n),o);return N(s)}async function P(e,t,n,o){const s=await g(t,h.GENERATE_CONTENT,e,!1,JSON.stringify(n),o),i=await s.json(),a=b(i);return{response:a}}
/**
 * @license
 * Copyright 2024 Google LLC
 *
